...
The team at [Kudos](http://gkudos.com/) has released a plugin for QGIS that  users to view, create, edit or delete data from their CartoDB accounts right from the QGIS desktop application.  Check out the [code on github](https://github.com/gkudos/qgis-cartodb), and see this blog post for a quick [overview](http://gkudos.com/blog/2014/09/23/Edit--CartoDB-Data-Using-QGIS/).
