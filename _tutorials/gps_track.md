...
![Tracks as points]({{ '/img/layout/tutorials/gps_track/img1.png' | prepend: site.baseurl }})
...
![Tracks]({{ '/img/layout/tutorials/gps_track/img2.png' | prepend: site.baseurl }})
...
![Styling tracks]({{ '/img/layout/tutorials/gps_track/img3.png' | prepend: site.baseurl }})
...
![Color ramp]({{ '/img/layout/tutorials/gps_track/img4.png' | prepend: site.baseurl }})
...
![Line plus points]({{ '/img/layout/tutorials/gps_track/img5.png' | prepend: site.baseurl }})
...
![Final map]({{ '/img/layout/tutorials/gps_track/img6.png' | prepend: site.baseurl }})
...
![Share]({{ '/img/layout/tutorials/gps_track/img7.png' | prepend: site.baseurl }})
